...
```bash
wget -O - https://raw.githubusercontent.com/cLabHM/klippain/main/install.sh | bash
```
...
```bash
wget -O - https://raw.githubusercontent.com/cLabHM/klippain/main/uninstall.sh | bash
```
